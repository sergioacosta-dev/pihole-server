...
This repo is documentation/reference for a self-hosted Pi-hole deployment, not a running application. Reports should focus on insecure configuration guidance or scripts in this repo.
